                ...
                <div class="modal-body">
                    <!-- <form class="form-horizontal form-label-left input_mask" method="post" id="upd" name="upd" enctype="multipart/form-data">-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                            <!-- <div class="col-md-9 col-sm-9 col-xs-12"> -->
                                <select class="form-control" name="cliente_id"  id="mod_cliente_id">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Asunto<span class="required">*</span></label>
                            <div class="col-md-9 col-sm-9 col-xs-12">

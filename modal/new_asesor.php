  <div> <!-- Modal -->
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg-add"><i class="fa fa-plus-circle"></i> Agregar Asesor</button>
    </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-label-left input_mask" id="add_asesor" name="add_asesor">
                        <div id="result_asesor"></div>
                        <!--Codigo ingresado por Carlos Bejarano -->
                         <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                <input name="username" required type="text" class="form-control" placeholder="Cargo" required>

                ...
                <div class="modal-body">
                    ...
                    <div class="tab-content">
                     <div class="tab-pane active" id="tab_1">
                        <form class="form-horizontal" method="post" action="action/updatencion_4.php" enctype="multipart/form-data">
                        <div id="result2"></div>
...
<script type="text/javascript" src="js/ticket_en_proceso.js"></script> -->

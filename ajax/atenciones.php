...
<?php
    if($action == 'ajax'){
        // escaping, additionally removing everything that could be (html/javascript-) code
         ...
         $sTable = "ticket";
         $sWhere = "where status_id IN (1,2,3,4,6)";
        if ( $_GET['q'] != "" )
        {
            $sWhere = "WHERE (";
            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                ?>
                    ...
                    <tr class="even pointer">
                        ...
                        <a href="#" class='btn btn-default' title='Editar Detalle de la atención' onclick="obtener_datos('<?php echo $id;?>');" data-toggle="modal" data-target=".bs-example-modal-lg-udp"><i class="glyphicon glyphicon-edit"></i></a> 
                        <!--<a href="#" class='btn btn-default' title='Borrar Ticket' onclick="eliminar('<?php echo $id; ?>')"><i class="glyphicon glyphicon-trash"></i> </a></span></td>--></span></td>
                    </tr>
                <?php
            } //en while
                ?>

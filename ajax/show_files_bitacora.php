        ...
        if ($numrows>0){
            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                ?>
                    ...
                    <input type="hidden" value="<?php echo $id;?>" id="id_ticket<?php echo $id;?>">
                    <input type="hidden" value="<?php echo $title;?>" id="title<?php echo $id2;?>">
                    ...
                    <tr class="even pointer">
                        ...
                        <a href="#" class='btn btn-default' title='Agregar atenciòn' onclick="obtener_datos('<?php echo $id;?>');" data-toggle="modal" data-target=".bs-example-modal-lg-udp"><i class="glyphicon glyphicon-edit"></i></a> 
                        ...
                        <a href="atender_tickets.php" class='btn btn-default' title='Agregar atenciòn' onclick="obtener_datos('<?php echo $id;?>');"data-toggle="modal" data-target=".bs-example-modal-lg-udp"><i class="glyphicon glyphicon-edit"></i></a> 
                        <a class='btn btn-default' href="atender_tickets.php" title='Agregar atenciòn'><i class="glyphicon glyphicon-edit"></i></a>-->
                    </tr>

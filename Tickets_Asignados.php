        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">                    
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="animated lightSpeedIn">Tickets Asignados</h2>
                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                ...
                                if(isset($_GET['ticket'])){
                                    ...
                                    $consulta="SELECT * FROM ticket WHERE status_id='2'";
                                ...
                                <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="ticketedit-view_asignado.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></a>

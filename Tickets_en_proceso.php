        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <?php                        
                        //include("modal/ticketedit-view.php");
                        //include("modal/upd_ticket_multimedia.php");
                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                ...
                                if(isset($_GET['ticket'])){
                                    ...
                                    $consulta="SELECT * FROM ticket WHERE status_id='3' order by id desc";
                                ...
                                <tbody>
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="ticketedit-view_process.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></a>                                            
                                        </td>
                                    </tr>
                                    <?php
                                        $ct++;

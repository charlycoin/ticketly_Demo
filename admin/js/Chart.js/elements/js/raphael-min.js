...
Raphael = (function () {
    var a = /[, ]+/,
        aY = /^(circle|rect|path|ellipse|text|image)$/,
        a9 = "prototype",
        W = "hasOwnProperty",
        P = document,
        aB = window,
        ...
        au = function () {
            if (au.is(arguments[0], "array")) {
                var d = arguments[0],
                    e = z[a7](au, d.splice(0, 3 + au.is(d[0], aq))),
                    S = e.set();
        ...
        at = " ",
        C = "split",
        J = "click dblclick mousedown mousemove mouseout mouseover mouseup" [C](at),
        aH = "join",
        n = "length",
        bb = String[a9].toLowerCase,
        af = Math,
        h = af.max,
        aR = af.min,
        aq = "number",
        ...
        a5 = /^(?=[\da-f]$)/,
        c = /^url\(['"]?([^\)]+?)['"]?\)$/i,
        A = /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgb\(\s*([\d\.]+\s*,\s*[\d\.]+\s*,\s*[\d\.]+)\s*\)|rgb\(\s*([\d\.]+%\s*,\s*[\d\.]+%\s*,\s*[\d\.]+%)\s*\)|hs[bl]\(\s*([\d\.]+\s*,\s*[\d\.]+\s*,\s*[\d\.]+)\s*\)|hs[bl]\(\s*([\d\.]+%\s*,\s*[\d\.]+%\s*,\s*[\d\.]+%)\s*\))\s*$/i,
        U = af.round,
        y = "setAttribute",
        aa = parseFloat,
        K = parseInt,
        aX = String[a9].toUpperCase,
        k = {
            blur: 0,
        ...
        aZ = "replace";
    au.version = "1.3.2";
    au.type = (aB.SVGAngle || P.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML");
    if (au.type == "VML") {
    ...
    au.is = function (e, d) {
        d = bb.call(d);
        return ((d == "object" || d == "undefined") && typeof e == d) || (e == null && d == "null") || bb.call(aE.call(e).slice(8, -1)) == d
    };
    ...
    var aM = function (e) {
            if (au.vml) {
                ...
                aM = an(function (i) {
                    E.style.color = i;
                    return P.defaultView.getComputedStyle(E, aA).getPropertyValue("color")
                })
            }
            return aM(e)
        };
    ...
    function an(E, e, d) {
        function i() {
            var R = Array[a9].slice.call(arguments, 0),
                bc = R[aH]("\u25ba"),
                S = i.cache = i.cache || {},
                bd = i.count = i.count || [];
            if (S[W](bc)) {
    ...
    var aC = /([achlmqstvz])[\s,]*((-?\d*\.?\d*(?:e[-+]?\d+)?\s*,?\s*)+)/ig,
        ar = /(-?\d*\.?\d*(?:e[-+]?\d+)?)\s*,?\s*/ig;
    ...
    au.findDotsAtSegment = function (e, d, bq, bo, bc, R, be, bd, bk) {
        var bi = 1 - bk,
            bh = aV(bi, 3) * e + aV(bi, 2) * 3 * bk * bq + bi * 3 * bk * bk * bc + aV(bk, 3) * be,
            bf = aV(bi, 3) * d + aV(bi, 2) * 3 * bk * bo + bi * 3 * bk * bk * R + aV(bk, 3) * bd,
            bm = e + 2 * bk * (bq - e) + bk * bk * (bc - 2 * bq + e),
            bl = d + 2 * bk * (bo - d) + bk * bk * (R - 2 * bo + d),
            bp = bq + 2 * bk * (bc - bq) + bk * bk * (be - 2 * bc + bq),
            bn = bo + 2 * bk * (R - bo) + bk * bk * (bd - 2 * R + bo),
            bj = (1 - bk) * e + bk * bq,
            bg = (1 - bk) * d + bk * bo,
            E = (1 - bk) * bc + bk * be,
            i = (1 - bk) * R + bk * bd,
            S = (90 - af.atan((bm - bp) / (bl - bn)) * 180 / af.PI);
        (bm > bp || bl < bn) && (S += 180);
        return {
            x: bh,
            y: bf,
    ...
    var Y = an(function (bh) {
        ...
        aT = function (e, E, bc, R, d, i) {
            var S = 1 / 3,
                bd = 2 / 3;
            return [S * e + bd * bc, S * E + bd * R, S * d + bd * bc, S * i + bd * R, d, i]
        },
        O = function (bl, bQ, bu, bs, bm, bg, S, bk, bP, bn) {
            var R = af.PI,
                ...
                d = R / 180 * (+bm || 0),
                by = [],
                bv, bM = an(function (bR, bU, i) {
                    var bT = bR * af.cos(i) - bU * af.sin(i),
                        bS = bR * af.sin(i) + bU * af.cos(i);
                    return {
                        x: bT,
                        y: bS
                    }
            ...
            if (!bn) {
                ...
                var E = bu * bu,
                    bD = bs * bs,
                    bF = (bg == S ? -1 : 1) * af.sqrt(af.abs((E * bD - E * bz * bz - bD * bA * bA) / (E * bz * bz + bD * bA * bA))),
                    bp = bF * bu * bz / bs + (bl + bk) / 2,
                    bo = bF * -bs * bA / bu + (bQ + bP) / 2,
                    bf = af.asin(((bQ - bo) / bs).toFixed(7)),
                    be = af.asin(((bP - bo) / bs).toFixed(7));
                bf = bl < bp ? R - bf : bf;
                be = bk < bp ? R - be : be;
                bf < 0 && (bf = R * 2 + bf);
                be < 0 && (be = R * 2 + be);
            ...
            var bd = af.cos(bf),
                ...
                bC = 4 / 3 * bs * bB,
                bL = [bl, bQ],
                bJ = [bl + bE * bO, bQ - bC * bd],
                bI = [bk + bE * bN, bP - bC * bc],
                bG = [bk, bP];
            bJ[0] = 2 * bL[0] - bJ[0];
            bJ[1] = 2 * bL[1] - bJ[1];
            if (bn) {
                ...
                for (var bH = 0, bx = by[n]; bH < bx; bH++) {
                    bw[bH] = bH % 2 ? bM(by[bH - 1], by[bH], d).y : bM(by[bH], by[bH + 1], d).x
                }
                return bw
            }
        },
        T = function (e, d, E, i, be, bd, bc, S, bf) {
            var R = 1 - bf;
            return {
                x: aV(R, 3) * e + aV(R, 2) * 3 * bf * E + R * 3 * bf * bf * be + aV(bf, 3) * bc,
                y: aV(R, 3) * d + aV(R, 2) * 3 * bf * i + R * 3 * bf * bf * bd + aV(bf, 3) * S
            }
        },
        aL = an(function (i, d, R, E, bl, bk, bh, be) {
            var bj = (bl - 2 * R + i) - (bh - 2 * bl + R),
                bg = 2 * (R - i) - 2 * (bl - R),
                bd = i - R,
    ...
    if (au.svg) {
        ...
        var b = function (R, bk, d) {
                var bh = "linear",
                    ...
                    bc = 0.5,
                    bm = R.style;
                bk = (bk + aA)[aZ](az, function (bo, i, bp) {
                    bh = "radial";
                    if (i && bp) {
                        be = aa(i);
                        bc = aa(bp);
                        var bn = ((bc > 0.5) * 2 - 1);
                        aV(be - 0.5, 2) + aV(bc - 0.5, 2) > 0.25 && (bc = af.sqrt(0.25 - aV(be - 0.5, 2)) * bn + 0.5) && bc != 0.5 && (bc = bc.toFixed(5) - 0.00001 * bn)
                    }
                    return aA
                });
                bk = bk[C](/\s*\-\s*/);
                if (bh == "linear") {
                    ...
                    var S = [0, 0, af.cos(bd * af.PI / 180), af.sin(bd * af.PI / 180)],
                        bj = 1 / (h(af.abs(S[2]), af.abs(S[3])) || 1);
                    S[2] *= bj;
                    S[3] *= bj;
                    if (S[2] < 0) {
                        S[0] = -S[2];
                ...
                for (var bf = 0, bl = bg[n]; bf < bl; bf++) {
                    var bi = aS("stop");
                    aS(bi, {
                        offset: bg[bf].offset ? bg[bf].offset : !bf ? "0%" : "100%",
        ...
        var ae = function (bi, br) {
                var bl = {
                    ...
                    S = function (by, bx) {
                        bx = bl[bb.call(bx)];
                        if (bx) {
                            var bv = by.attrs["stroke-width"] || "1",
                                bt = {
                                    round: bv,
                                    square: bv,
                                    butt: 0
                                }[by.attrs["stroke-linecap"] || br["stroke-linecap"]] || 0,
                                bw = [];
                            var bu = bx[n];
                            while (bu--) {
                ...
                for (var bm in br) {
                    if (br[W](bm)) {
                        ...
                        case "clip-rect":
                            var e = (bk + aA)[C](a);
                            if (e[n] == 4) {
                                bi.clip && bi.clip.parentNode.parentNode.removeChild(bi.clip.parentNode);
                                var i = aS("clipPath"),
                                    bo = aS("rect");
                                i.id = "r" + (au._id++)[aJ](36);
                                aS(bo, {
                            ...
                            if (!bk) {
                                var bq = P.getElementById(bn.getAttribute("clip-path")[aZ](/(^url\(#|\)$)/g, aA));
                        ...
                        case "scale":
                            bc = (bk + aA)[C](a);
                            bi.scale(+bc[0] || 1, +bc[1] || +bc[0] || 1, isNaN(aa(bc[2])) ? null : +bc[2], isNaN(aa(bc[3])) ? null : +bc[3]);
                            break;
                        case "fill":
                            var R = (bk + aA).match(c);
                            if (R) {
                            ...
                            if (!au.getRGB(bk).error) {
                                delete br.gradient;
                                delete bj.gradient;
                                !au.is(bj.opacity, "undefined") && au.is(br.opacity, "undefined") && aS(bn, {
                                    opacity: bj.opacity
                                });
                                !au.is(bj["fill-opacity"], "undefined") && au.is(br["fill-opacity"], "undefined") && aS(bn, {
                                ...
                                if ((({
                                    circle: 1,
                                    ellipse: 1
                                })[W](bi.type) || (bk + aA).charAt() != "r") && b(bn, bk, bi.paper)) {
                                    bj.gradient = bk;
                                    bj.fill = "none";
                                    break
                                }
                        ...
                        case "fill-opacity":
                            if (bj.gradient) {
                                var d = P.getElementById(bn.getAttribute("fill")[aZ](/^url\(#|\)$/g, aA));
                                if (d) {
        ...
        var j = 1.2,
            I = function (d, R) {
                if (d.type != "text" || !(R[W]("text") || R[W]("font") || R[W]("font-size") || R[W]("x") || R[W]("y"))) {
                    return
                }
                var bf = d.attrs,
                    e = d.node,
                    bh = e.firstChild ? K(P.defaultView.getComputedStyle(e.firstChild, aA).getPropertyValue("font-size"), 10) : 10;
                if (R[W]("text")) {
                    bf.text = R.text;
                    while (e.firstChild) {
        ...
        aF[a9].rotate = function (e, d, E) {
            ...
            if (e == null) {
                if (this._.rt.cx) {
                    return [this._.rt.deg, this._.rt.cx, this._.rt.cy][aH](at)
                }
            ...
            if (this._.rt.deg) {
                this.transformations[0] = au.format("rotate({0} {1} {2})", this._.rt.deg, d, E);
                this.clip && aS(this.clip, {
                    transform: au.format("rotate({0} {1} {2})", -this._.rt.deg, d, E)
                })
            } else {
        ...
        aF[a9].getBBox = function () {
            ...
            if (this.type == "text") {
                ...
                for (var d = 0, R = this.node.getNumberOfChars(); d < R; d++) {
                    ...
                    (bc.y < bd.y) && (bd.y = bc.y);
                    (bc.y + bc.height - bd.y > bd.height) && (bd.height = bc.y + bc.height - bd.y);
                    (bc.x + bc.width - bd.x > bd.width) && (bd.width = bc.x + bc.width - bd.x)
                }
            }
            E && this.hide();
            return bd
        ...
        var z = function () {
                ...
                if (i == 1) {
                    S.style.cssText = "position:absolute;left:" + e + "px;top:" + bc + "px";
                    P.body[aU](S)
                } else {
                    if (i.firstChild) {
        ...
        a4[a9].clear = function () {
            ...
            (this.desc = aS("desc"))[aU](P.createTextNode("Created with Rapha\xebl"));
            d[aU](this.desc);
    ...
    if (au.vml) {
        ...
        ae = function (bf, bk) {
            ...
            if (bk.scale) {
                E = (bk.scale + aA)[C](a);
                bf.scale(+E[0] || 1, +E[1] || +E[0] || 1, +E[2] || null, +E[3] || null)
            }
            if ("clip-rect" in bk) {
                ...
                if (d[n] == 4) {
                    d[2] = +d[2] + (+d[0]);
                    d[3] = +d[3] + (+d[1]);
                    var be = bi.clipRect || P.createElement("div"),
                        bo = be.style,
                        S = bi.parentNode;
            ...
            if (bf.type == "image" && bk.opacity) {
                bi.filterOpacity = " progid:DXImageTransform.Microsoft.Alpha(opacity=" + (bk.opacity * 100) + ")";
                bc.filter = (bi.filterMatrix || aA) + (bi.filterOpacity || aA)
            }
            bk.font && (bc.font = bk.font);
            bk["font-family"] && (bc.fontFamily = '"' + bk["font-family"][C](",")[0][aZ](/^['"]+|['"]+$/g, aA) + '"');
            bk["font-size"] && (bc.fontSize = bk["font-size"]);
            bk["font-weight"] && (bc.fontWeight = bk["font-weight"]);
            bk["font-style"] && (bc.fontStyle = bk["font-style"]);
            if (bk.opacity != null || bk["stroke-width"] != null || bk.fill != null || bk.stroke != null || bk["stroke-width"] != null || bk["stroke-opacity"] != null || bk["fill-opacity"] != null || bk["stroke-dasharray"] != null || bk["stroke-miterlimit"] != null || bk["stroke-linejoin"] != null || bk["stroke-linecap"] != null) {
                bi = bf.shape || bi;
                var bj = (bi.getElementsByTagName("fill") && bi.getElementsByTagName("fill")[0]),
                    bm = false;
                !bj && (bm = bj = al("fill"));
                if ("fill-opacity" in bk || "opacity" in bk) {
                    var e = ((+bl["fill-opacity"] + 1 || 2) - 1) * ((+bl.opacity + 1 || 2) - 1);
                    e < 0 && (e = 0);
                    e > 1 && (e = 1);
                    bj.opacity = e
                }
                ...
                bm && bi[aU](bj);
                var R = (bi.getElementsByTagName("stroke") && bi.getElementsByTagName("stroke")[0]),
                    bn = false;
                !R && (bn = R = al("stroke"));
                if ((bk.stroke && bk.stroke != "none") || bk["stroke-width"] || bk["stroke-opacity"] != null || bk["stroke-dasharray"] || bk["stroke-miterlimit"] || bk["stroke-linejoin"] || bk["stroke-linecap"]) {
                    R.on = true
                }(bk.stroke == "none" || R.on == null || bk.stroke == 0 || bk["stroke-width"] == 0) && (R.on = false);
                R.on && bk.stroke && (R.color = au.getRGB(bk.stroke).hex);
                e = ((+bl["stroke-opacity"] + 1 || 2) - 1) * ((+bl.opacity + 1 || 2) - 1);
                ...
                R.opacity = e;
                bk["stroke-linejoin"] && (R.joinstyle = bk["stroke-linejoin"] || "miter");
                R.miterlimit = bk["stroke-miterlimit"] || 8;
                bk["stroke-linecap"] && (R.endcap = bk["stroke-linecap"] == "butt" ? "flat" : bk["stroke-linecap"] == "square" ? "square" : "round");
                if (bk["stroke-dasharray"]) {
                    ...
                    R.dashstyle = bh[W](bk["stroke-dasharray"]) ? bh[bk["stroke-dasharray"]] : aA
                }
                bn && bi[aU](R)
            }
            if (bp.type == "text") {
                ...
                bp.node.string && (bp.paper.span.innerHTML = (bp.node.string + aA)[aZ](/</g, "&#60;")[aZ](/&/g, "&#38;")[aZ](/\n/g, "<br>"));
        ...
        b = function (d, bd) {
            d.attrs = d.attrs || {};
            var be = d.attrs,
                bg = d.node.getElementsByTagName("fill"),
                S = "linear",
                bc = ".5 .5";
            d.attrs.gradient = bd;
            bd = (bd + aA)[aZ](az, function (bi, bj, i) {
                ...
                if (bj && i) {
                    bj = aa(bj);
                    i = aa(i);
                    aV(bj - 0.5, 2) + aV(i - 0.5, 2) > 0.25 && (i = af.sqrt(0.25 - aV(bj - 0.5, 2)) * ((i > 0.5) * 2 - 1) + 0.5);
                    bc = bj + at + i
                }
                return aA
            });
            ...
            if (R[n]) {
                ...
                bg.colors && (bg.colors.value = bh[n] ? bh[aH](",") : "0% " + bg.color);
                if (S == "radial") {
                    bg.focus = "100%";
                    bg.focussize = bc;
                    bg.focusposition = bc
        ...
        aF[a9].setBox = function (bo, e, d) {
            ...
            case "image":
                ...
                break;
            case "text":
                this.textpath.v = ["m", U(bk.x), ", ", U(bk.y - 2), "l", U(bk.x) + 1, ", ", U(bk.y - 2)][aH](aA);
                bd = bk.x - U(this.W / 2);
                bc = bk.y - this.H / 2;
                be = this.W;
                bn = this.H;
            ...
            if (this.type == "path") {
                ...
                if (this.type == "text") {
                    ...
                    bi.width != (bg = this.paper.width + "px") && (bi.width = bg);
                    bi.height != (bg = this.paper.height + "px") && (bi.height = bg);
                    ...
                    if (this.type == "rect" && this.arcsize.toFixed(4) != S.toFixed(4) && (S || this.arcsize)) {
                        ...
                        if (this.events) {
                            for (; bm < bf; bm++) {
                                this.events[bm].unbind = ai(this.node, this.events[bm].name, this.events[bm].f, this)
                            }
                        }
                    }
                }
        ...
        aF[a9].blur = function (d) {
            ...
            if (+d !== 0) {
                this.attrs.blur = d;
                e.filter = i + " progid:DXImageTransform.Microsoft.Blur(pixelradius=" + (+d || 1.5) + ")";
        ...
        ab = function (e, be, bd, bf) {
            ...
            R.coordsize = aI;
            R.coordorigin = e.coordorigin;
            bg.v = au.format("m{0},{1}l{2},{1}", U(be * 10), U(bd * 10), U(be * 10) + 1);
            bg.textpathok = true;
            bc.width = e.width;
            bc.height = e.height;
            i.string = bf + aA;
        ...
        try {
            !P.namespaces.rvml && P.namespaces.add("rvml", "urn:schemas-microsoft-com:vml");
            al = function (d) {
                return P.createElement("<rvml:" + d + ' class="rvml">')
            }
        } catch (aj) {
            al = function (d) {
                return P.createElement("<" + d + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">')
            }
        }
        z = function () {
            var i = av[a7](0, arguments),
                d = i.container,
                be = i.height,
                bf, e = i.width,
                bd = i.x,
            ...
            var R = new a4,
                S = R.canvas = P.createElement("div"),
                E = S.style;
            e = e || 512;
            be = be || 342;
            e == +e && (e += "px");
            ...
            S[aU](R.span);
            E.cssText = au.format("width:{0};height:{1};position:absolute;clip:rect(0 {0} {1} 0);overflow:hidden", e, be);
            if (d == 1) {
                P.body[aU](S);
                E.left = bd + "px";
                E.top = bc + "px"
    ...
    if ((/^Apple|^Google/).test(aB.navigator.vendor) && !(aB.navigator.userAgent.indexOf("Version/4.0") + 1)) {
    ...
    a4[a9].set = function (d) {
        arguments[n] > 1 && (d = Array[a9].splice.call(arguments, 0, arguments[n]));
        return new X(d)
    };
    a4[a9].setSize = a6;
        ...
        if (bi != 0) {
            ...
            if (this.type in {
                ...
                if (this.transformations) {
                    ...
                    this.node.filterMatrix = " progid:DXImageTransform.Microsoft.Matrix(M11=" [a2](bf, ", M12=0, M21=0, M22=", bc, ", Dx=0, Dy=0, sizingmethod='auto expand', filtertype='bilinear')");
                    bp.filter = (this.node.filterMatrix || aA) + (this.node.filterOpacity || aA)
                }
            } else {
                if (this.transformations) {
            ...
            return function (bl, S, bc) {
                ...
                for (var be = 0, bj = bl.length; be < bj; be++) {
                    ...
                    if (E[0] == "M") {
                        ...
                        if (bf + bd > S) {
                            if (e && !bk.start) {
                                bi = g(bh, bg, E[1], E[2], E[3], E[4], E[5], E[6], S - bf);
                                R += ["C", bi.start.x, bi.start.y, bi.m.x, bi.m.y, bi.x, bi.y];
                                if (bc) {
                                    return R
                                }
                                bk.start = R;
                                R = ["M", bi.x, bi.y + "C", bi.n.x, bi.n.y, bi.end.x, bi.end.y, E[5], E[6]][aH]();
                                bf += bd;
                                bh = +E[5];
                                bg = +E[6];
                                continue
                ...
                bk.end = R;
                bi = d ? bf : e ? bk : au.findDotsAtSegment(bh, bg, E[1], E[2], E[3], E[4], E[5], E[6], 1);
                bi.alpha && (bi = {
                    x: bi.x,
                    y: bi.y,
                    alpha: bi.alpha
            ...
            for (var bq in M) {
                if (bq != "length" && M[W](bq)) {
                    ...
                    var bc = be - bv.start,
                        ...
                        d;
                    if (bc < bn) {
                        var S = au.easing_formulas[bm] ? au.easing_formulas[bm](bc / bn) : bc / bn;
                        for (var bo in br) {
                            if (br[W](bo)) {
                                switch (ad[bo]) {
                                case "along":
                                    ...
                                    E.back && (d = E.len - d);
                                    var bp = G(E[bo], d);
                                    bd.translate(bj.sx - bj.x || 0, bj.sy - bj.y || 0);
                                    bj.x = bp.x;
                                    bj.y = bp.y;
                                ...
                                case "number":
                                    ...
                                    break;
                                case "colour":
                                    d = "rgb(" + [F(U(br[bo].r + S * bn * bj[bo].r)), F(U(br[bo].g + S * bn * bj[bo].g)), F(U(br[bo].b + S * bn * bj[bo].b))][aH](",") + ")";
                                    break;
                                case "path":
                                    d = [];
                                    for (var bt = 0, bh = br[bo][n]; bt < bh; bt++) {
                                        ...
                                        for (var bs = 1, bu = br[bo][bt][n]; bs < bu; bs++) {
                                            d[bt][bs] = +br[bo][bt][bs] + S * bn * bj[bo][bt][bs]
                                        }
                                        d[bt] = d[bt][aH](at)
                                    }
                                    d = d[aH](at);
                                ...
                                case "csv":
                                    ...
                                    case "rotation":
                                        ...
                                        br[bo][1] && (d += "," + br[bo][1] + "," + br[bo][2]);
                                        break;
                                    case "scale":
                                        d = [+br[bo][0] + S * bn * bj[bo][0], +br[bo][1] + S * bn * bj[bo][1], (2 in E[bo] ? E[bo][2] : aA), (3 in E[bo] ? E[bo][3] : aA)][aH](at);
                                        break;
                                    case "clip-rect":
                                        d = [];
                                        bt = 4;
                                        while (bt--) {
                                            d[bt] = +br[bo][bt] + S * bn * bj[bo][bt]
                                        }
                                        break
                                    }
                                    break
                        ...
                        if (E.along) {
                            ...
                            bd.translate(bj.sx - (bj.x || 0) + bp.x - bj.sx, bj.sy - (bj.y || 0) + bp.y - bj.sy);
                            E.rot && bd.rotate(bj.r + bp.alpha, bp.x, bp.y)
                    ...
                    case "path":
                        ...
                        for (var bn = 0, bd = bl[bi][n]; bn < bd; bn++) {
                            ...
                            for (var bm = 1, bp = bl[bi][bn][n]; bm < bp; bm++) {
                                be[bi][bn][bm] = (bf[bn][bm] - bl[bi][bn][bm]) / bh
                            }
                        }
                        break;
                    case "csv":
                        ...
                        case "translation":
                            ...
                            break;
                        case "rotation":
                            bl[bi] = (bc[1] == d[1] && bc[2] == d[2]) ? bc : [0, d[1], d[2]];
                            be[bi] = [(d[0] - bl[bi][0]) / bh, 0, 0];
                            break;
                        case "scale":
                            bq[bi] = d;
                            bl[bi] = (bl[bi] + aA)[C](a);
                            be[bi] = [(d[0] - bl[bi][0]) / bh, (d[1] - bl[bi][1]) / bh, 0, 0];
                            break;
                        case "clip-rect":
                            bl[bi] = (bl[bi] + aA)[C](a);
                            be[bi] = [];
    ...
    a4[a9].getFont = function (be, bf, e, R) {
        ...
        var S = au.fonts[be];
        if (!S) {
            var E = new RegExp("(^|\\s)" + be[aZ](/[^\w\d\s+!~.:_-]/g, aA) + "(\\s|$)", "i");
        ...
        if (S) {
            for (var bd = 0, bg = S[n]; bd < bg; bd++) {
                bc = S[bd];
                if (bc.face["font-weight"] == bf && (bc.face["font-style"] == e || !bc.face["font-style"]) && bc.face["font-stretch"] == R) {
                    break
                }
            }
        }
    ...
    a4[a9].print = function (R, E, d, bd, be, bn) {
        ...
        if (bd) {
            ...
            var e = bd.face.bbox.split(a),
                bc = +e[0],
                bf = +e[1] + (bn == "baseline" ? e[3] - e[1] + (+bd.face.descent) : (e[3] - e[1]) / 2);
            for (var bi = 0, S = bm[n]; bi < S; bi++) {
                var bh = bi && bd.glyphs[bm[bi - 1]] || {},
                    bl = bd.glyphs[bm[bi]];
